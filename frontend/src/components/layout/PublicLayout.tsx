...
export function PublicLayout() {
    ...
    return (
        <div className="font-sans antialiased text-slate-800 bg-black min-h-screen flex flex-col">
            ...
            <div className={`fixed inset-0 z-50 bg-black/98 backdrop-blur-2xl transform transition-transform duration-300 md:hidden flex flex-col items-center justify-center space-y-8 ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
                {/* Close Button */}
                <button
