                                ...
                                <View style={styles.headerContainer}>
                                    ...
                                    <View style={styles.headerRight}>
                                        <View style={styles.customerRow}>
                                            ...
                                            <Text style={styles.customerValue}>{invoice.customer?.name || 'N/A'}</Text>
                                        </View>
                                        <View style={styles.customerRow}>
                                            <Text style={styles.customerLabel}>Vehicle No. :</Text>
                                            <Text style={styles.customerValue}>{invoice.vehicle?.vehicle_number || 'N/A'}</Text>
                                        </View>
                                        <View style={styles.customerRow}>
                                            <Text style={styles.customerLabel}>Model :</Text>
                                            <Text style={styles.customerValue}>
                                                {(invoice.vehicle?.make || 'N/A') + ' ' + (invoice.vehicle?.model || '')}
                                            </Text>
                                        </View>
                                        <View style={styles.customerRow}>
                                            <Text style={styles.customerLabel}>Mileage (Km.) :</Text>
                                            <Text style={styles.customerValue}>{invoice.mileage || 'N/A'}</Text>
                                        </View>
                                        <View style={{ flexDirection: 'row', marginTop: 4 }}>
                                            <View style={{ flexDirection: 'row', flex: 1 }}>
                                                <Text style={styles.customerLabel}>Date :</Text>
                                                <Text style={{ ...styles.customerValue, flex: 0, width: 60 }}>
                                                    {new Date(invoice.created_at).toLocaleString("en-IN", { timeZone: 'Asia/Kolkata', day: '2-digit', month: '2-digit', year: 'numeric' })}
                                                </Text>
                                            </View>
